...
exports.LibHasDeprecatedInputsComponent = void 0;
const core_1 = require("@angular/core");
const defaultSymbol = Symbol('default');
let LibHasDeprecatedInputsComponent = (() => {
    ...
    var LibHasDeprecatedInputsComponent = class {
        ...
        static {
            ...
            LibHasDeprecatedInputsComponent = _classThis = _classDescriptor.value;
    ...
    return LibHasDeprecatedInputsComponent = _classThis;
})();
exports.LibHasDeprecatedInputsComponent = LibHasDeprecatedInputsComponent;
